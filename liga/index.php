<?php
 ...
 /*Punto numero 2 del examen:
	 *
	 *Agregar el campo "fecha_nacimiento" al formulario de insertar y validar que solo inserte si es mayor de edad hoy
	 *
	*/
 ...
 if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
  ...
  HTML::cabeceras(array('title'      =>'Liga Examen 09/04/19',
			'description'=>'Página de pruebas para LIGA 3',
			'css'        => array('css/jquery-ui/liga/jquery-ui-1.9.2.liga.min.css','util/LIGA.css'),
